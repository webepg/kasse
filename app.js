      ...
      var DEFAULT_STATE_URL =
        "https://gist.githubusercontent.com/webepg/66c8611569a737ac0a758d6a3b82519c/raw/state";
      ...
      function renderCart() {
        ...
        if (cart.length === 0) {
          el.innerHTML =
            '<div class="cart-empty-msg">Noch nichts gewählt</div>';
        } else {
          var html = "";
          for (var i = 0; i < cart.length; i++) {
            var c = cart[i];
